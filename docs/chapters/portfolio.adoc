...
* it avoids you to send messages on the event bus and manage object marshalling and unmarshalling for you.
...
INFO: Did you know that the term `Future` has been introduced in 1977, `Promise` in 1976... Not really new things.
